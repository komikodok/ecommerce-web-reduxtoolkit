...
const ProductItemModal = ({ product }: { product: IProducts }) => {
  return (
    <Drawer>
        ...
        <DrawerContent className="max-w-xl mx-auto max-h-fit space-y-4 bg-white overflow-hidden border-none">
            ...
            <DrawerDescription className="px-2 text-stone-500 text-center">
                {product.description}
            </DrawerDescription>
